...
namespace Ufba.ShHome
{
	...
	/// </remarks>
	public partial class ShHomeHelpKeywordHelper : ShHomeHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new ShHomeHelpKeywordHelper.
		/// </summary>
		protected ShHomeHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the ShHomeHelpKeywordHelper.
		/// </summary>
		public static ShHomeHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class ShHomeHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new ShHomeHelpKeywordHelperBase.
		/// </summary>
		protected ShHomeHelpKeywordHelperBase()
			: base() { }
