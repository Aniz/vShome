...
namespace Ufba.ShHome
{
	...
	/// </summary>
	internal partial class ShHomeDocView : ShHomeDocViewBase
	{
		/// <summary>
		/// Constructs a new ShHomeDocView.
		/// </summary>
		public ShHomeDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class ShHomeDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new ShHomeDocView.
		/// </summary>
		protected ShHomeDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			ShHomeDocDataBase docData = this.DocData as ShHomeDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for ShHomeDocViewBase should be an ShHomeDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Ufba.ShHome.ShHomeDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Ufba.ShHome.ShHomeDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Ufba.ShHome.ShHomeToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Ufba.ShHome.ShHomeToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.ShHomeDiagramMenu;
			}
		}
			...
			if(global::Ufba.ShHome.ShHomeHelpKeywordHelper.Instance != null)
			{
				...
				if(selectedElement != null)
				{
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Ufba.ShHome.ShHomeHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
