...
namespace Ufba.ShHome
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.ShHomeEditorFactoryId)]
	internal partial class ShHomeEditorFactory : ShHomeEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new ShHomeEditorFactory.
		/// </summary>
		public ShHomeEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class ShHomeEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected ShHomeEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new ShHomeDocData(this.ServiceProvider, typeof(ShHomeEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new ShHomeDocView(docData, this.ServiceProvider);
		}
	}
}
