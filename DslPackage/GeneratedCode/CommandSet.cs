...
namespace Ufba.ShHome
{
	...
	/// </summary>
	internal partial class ShHomeCommandSet : ShHomeCommandSetBase
	{
		/// <summary>
		/// Constructs a new ShHomeCommandSet.
		/// </summary>
		public ShHomeCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class ShHomeCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new ShHomeCommandSetBase.
		/// </summary>
		protected ShHomeCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewShHomeExplorerCommand,
				typeof(ShHomeEditorFactory).GUID);
		...
		{
			ShHomeExplorerToolWindow explorer = this.ShHomeExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected ShHomeDocData CurrentShHomeDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as ShHomeDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected ShHomeDocView CurrentShHomeDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as ShHomeDocView;
			}
		}
		...
		/// </summary>
		protected ShHomeExplorerToolWindow ShHomeExplorerToolWindow
		{
			get
			{
				ShHomeExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(ShHomeExplorerToolWindow), true) as ShHomeExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				ShHomeExplorerToolWindow explorerWindow = this.ShHomeExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class ShHomeClipboardCommandSet : ShHomeClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new ShHomeClipboardCommandSet.
		/// </summary>
		public ShHomeClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class ShHomeClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new ShHomeClipboardCommandSetBase.
		/// </summary>
		protected ShHomeClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
